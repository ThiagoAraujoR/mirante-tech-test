...
-- Usado pelo sandbox de validação dinâmica.
-- =============================================================
...
CREATE INDEX IF NOT EXISTS idx_transacoes_origem
    ON transacoes(conta_origem_id, data_transacao);
CREATE INDEX IF NOT EXISTS idx_transacoes_destino
    ON transacoes(conta_destino_id, data_transacao);
CREATE INDEX IF NOT EXISTS idx_log_entidade
    ON log_auditoria(entidade, entidade_id);
